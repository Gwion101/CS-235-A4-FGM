...
public class DataVisualizerGUI extends JFrame {
	...
	private JButton m_BarChart_Button;
    ...
    private class GUIEventHandler implements ActionListener{
         ...
         public void actionPerformed(ActionEvent event) {
             ...
             if (event.getSource() ==  m_BarChart_Button){
            	 ChartSetup m_ChartSetup;
 				try {
    ...
    private JPanel createButtonPanel(){
        ...
        m_BarChart_Button = new JButton("Bar Chart");
        m_BarChart_Button.addActionListener(m_handler);
        m_PieChart_Button = new JButton("Pie Chart");
        ...
        //m_panel.add(Box.createHorizontalStrut(5));
        m_panel.add(m_BarChart_Button);
        m_panel.add(m_PieChart_Button);
